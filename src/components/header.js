...
const Header = ({ siteTitle }) => {
  ...
  const showBanner = () => setShowResults(true)
  ...
  useEffect(() => {
    if (isBrowser) {
      window.addEventListener('scroll', () => {
        ...
        if (scroll >= 150) sticky.classList.add('sticky-show')
        else sticky.classList.remove('sticky-show')
      })
    }
  }, [checkout])
    ...
    <>
      <header className="header-main">
        ...
        >
          <p
            ...
            style={{ fontSize: '1rem' }}
          >
            We offer curbside pick-up | Free delivery within GTA orders over $45
            ...
            <div className="row no-gutters w-100">
                ...
                <Navbar light={true} expand="lg" className="bg-transparent p-0">
                  ...
                  <div className="d-lg-flex w-100">
                    <Nav
                      ...
                      navbar
                    >
                      <Nav.Item className="mx-3 my-0 d-inline-block py-md-3 py-lg-0">
                        <Link
              ...
              <div className="col col-md-2 col-lg-1 d-flex flex-wrap align-self-center align-items-center justify-content-end order-lg-2">
                <div className="navbar-end d-block d-lg-flex text-center pb-0">
                  <div className="navbar-item search-icon d-none">
                    <span
      ...
      <div className="minicart__overlay" onClick={toggleMiniCart}>
        <div className="cart__message">
          Free delivery within GTA on orders over $45
        </div>
      </div>
    </>
  )
