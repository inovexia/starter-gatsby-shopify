...
const ProductPage = ({ data }) => {
  ...
  const productID = parseInt(atob(product.shopifyId).split('/').pop())
  ...
  const fetchAllRating = useCallback(async URL => {
  ...
  const vegan_products =
    productID == 4307903283309 || productID == 4308712390765
  ...
  return (
    <>
          ...
          <Row className="mx-0 pt-3 pt-lg-5">
            ...
            <Col className="col-12 col-md-6 pl-3 pl-lg-5">
              <div className="single-product-details pl-lg-5">
                ...
                <div
                  className={
                    'badges my-3 ' + (vegan_products ? 'not-vegan' : '')
                  }
                >
                  <span>Natural, Organic & Not tested on animals</span>
                </div>
                <AddToCompare
      ...
      <div className={` ${modal === true ? 'modal is-active' : 'modal'}`}>
        ...
        <div
          className="modal-content bg-transparent product-zoom"
          onClick={closeModal}
        >
          <img src={modalImage} />
        </div>
